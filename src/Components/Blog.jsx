    ...
    <section className="py-5 bg-light">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 mb-4">
            <div className="card ">
              <img className="card-img-top" src="https://img.freepik.com/free-photo/dancing-team-studio_1303-10942.jpg?t=st=1717306766~exp=1717310366~hmac=b24dfef9f05e66ce572336c4ecf9101d76af487225cad672ad4eb20b9325674f&w=826" alt="Blog 2" />
              <div className="card-body">
                <h5 className="card-title">Akhsara Registration Open</h5>
                <p className="card-text">Lorem ipsum dolor sit amet,cin Vivamus efficitur ultrices enim nec scelerisque. ipsum dolor  consectetur adipiscing  </p>
                <a href="#" className="btn blogbtn rounded-pill ">Read More</a>
              </div>
            </div>
          </div>
          <div className="col-lg-4 mb-4">
            <div className="card ">
              <img className="card-img-top" src="https://img.freepik.com/free-photo/high-angle-group-smiley-childrens_23-2148445717.jpg?t=st=1717306825~exp=1717310425~hmac=8984818466e76c11e645faeb588e68b3f135ee510eafcd3ea0e33860df73f2f2&w=826" alt="Blog 3" />
              <div className="card-body">
